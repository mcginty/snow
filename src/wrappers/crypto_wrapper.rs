...
impl Cipher for CipherChaChaPoly {
    ...
    fn encrypt(&self, nonce: u64, authtext: &[u8], plaintext: &[u8], out: &mut [u8]) -> usize {
        ...
        let tag =
            chacha20_poly1305_aead::encrypt(&self.key, &nonce_bytes, authtext, plaintext, &mut buf);
        let tag = tag.unwrap();
...
mod tests {
    ...
    fn test_sha256() {
        ...
        assert!(
            output.to_hex() == "ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad"
        );
    }
    ...
    fn test_hmac_sha256_sha512() {
        ...
        assert!(
            output1.to_hex() == "773ea91e36800e46854db8ebd09181a72959098b3ef8c122d9635514ced565fe"
        );
    ...
    fn test_curve25519() {
        ...
        assert!(
            output.to_hex() == "c3da55379de9c6908e94ea4df28d084f32eccf03491c71f754b4075577a28552"
        );
    }
    ...
    fn test_aes256_gcm() {
        ...
        cipher2.set(&key);
        cipher2
            .decrypt(nonce, &authtext, &ciphertext, &mut resulttext)
            .unwrap();
        ...
        cipher4.set(&key);
        cipher4
            .decrypt(nonce, &authtext, &ciphertext2, &mut resulttext2)
            .unwrap();
